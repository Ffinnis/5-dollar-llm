...
def main():
    ...
    parser.add_argument("--layer_drop_alpha", type=float, help="Layer dropping bias strength for epoch-shift (default: 0.5)")
    ...
    if args.layer_drop_alpha is not None:
        config.layer_drop_alpha = args.layer_drop_alpha
